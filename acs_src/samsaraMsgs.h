...
int ClassPickupMessages[CLASSCOUNT][MAXMODES][SLOTCOUNT][MSGCOUNT] = 
{
    ...
    {{ // Strifeguy
        ...
        { // Punchdrunk Chainsaw.
            "You picked up Stamina and Accuracy Upgrades!",
            "Free Steroids!",
            "Maybe now you're gonna learn how to aim.",
            "After 10 you're gonna win every game.",
            "Because Strife is an RPG game.",
            "LEVEL UP!",
            "",
            "",
            "",
	...
	{{
        ...
        { "Grenade Launcher!","Coated in flying rubber.","I like big weapons!","Woah, already?","That escalated quickly.","Aww, no fair, Wang! How come Samsara lets you have Slot 2 Grenade Launcher?","You have S tier damage for a reason.","Shotgun? Crossbow? Magnum? Assault Rifle? Magic Stone? Lol, nah!","Post-Duke Build engine weapons were mildly overpowered.","It's all in the reflexes.",},
	...
	{{
		...
		{ "Chicken Crossbow!","What're you, chicken?","Look out! It's the crazy chicken!","Mmm, poultry!","Want sum' buffalo wings?","Who wants to see sum' redneck fireworks?","PETA will never catch me alive!","See? Chickens ain't no flightless birds, moran!","BOK! BOK BOK BOK BOOOOOK!","They'll never see it comin'....",},
		...
		},
{
	...
	{{ "Huntin' Scope Rifle... or Dyn'O'mites?","I'm goin' redneck deer huntin'!","Bubba! Where'd you put the damn deer caller?","Aw shucks! I forgot to oil the bolt again!","These are tons of fun on the fourth o' joolye!","Imma throw these in the toilet!","These make fishin' easy!","","","",}},	
	{{
