...
{ 
	...
	{{"Eleena", 14, "****", "*", "**", "****", "****", "Area Denial", "TIPSYM14", "TIPHIL14", "TIPELENA", "TPLGERAD", "TPCHERAD", "SMALLFONT", "Orange", "SMALLFONT", "Orange", "CMPBGER1", "CMPBGER2", "CMPBGER3", "CMPBGER4", "CMPBGER5", "", "", "", "DarkGray", "White" }},
	...
	{{"LDF Commando", 16, "*", "***", "*****", "****", "**", "Marksman", "TIPSYM16", "TIPHIL16", "TIPREBEL", "TPLGRMR", "TPCHRMR", "SMALLFONT", "LightBlue", "SMALLFONT", "LightBlue", "CMPBGRB1", "CMPBGRB2", "CMPBGRB3", "CMPBGRB4", "CMPBGRB5", "CMPBGRB6", "", "", "DarkGray", "White" }},
	{{"Kyle Katarn", 17, "***", "****", "***", "*****", "***", "Assault", "TIPSYM17", "TIPHIL17", "TIPKYLEK", "TPLGKYLE", "TPCHKYLE", "SMALLFONT", "Orange", "SMALLFONT", "Orange", "CMPBGDF1", "CMPBGDF2", "CMPBGDF3", "CMPBGDF4", "CMPBGDF5", "", "", "", "DarkGray", "White" }},
	...
	{{"Jack Curtis", 19, "*****", "***", "***", "****", "**", "Psychic", "TIPSYM19", "TIPHIL19", "TIPJACKC", "TPLGJACK", "TPCHJACK", "SMALLFONT", "White", "SMALLFONT", "White", "CMPBGDS1", "CMPBGDS2", "CMPBGDS3", "CMPBGDS4", "CMPBGDS5", "", "", "", "DarkGray", "White" }},
	...
	{{"Jon", 24, "****", "***", "***", "**", "***", "Veteran", "TIPSYM24", "TIPHIL24", "TIPPSJON", "TPLGPSEX", "TPCHPSEX", "SMALLFONT", "Orange", "SMALLFONT", "Orange", "CMPBGPS1", "CMPBGPS2", "CMPBGPS3", "CMPBGPS4", "CMPBGPS5", "CMPBGPS6", "CMPBGPS7", "CMPBGPS8", "DarkGray", "White" }},
	...
	{{"Bitterman", 26, "***", "***", "****", "**", "***", "Armory", "TIPSYM26", "TIPHIL26", "TIPQ2MAN", "TPLGBITT", "TPCHBITT", "CMPSQUA2", "Quake2CompendiumWhite", "CMPSQUA2", "Quake2CompendiumGreen", "CMPBGQ21", "CMPBGQ22", "CMPBGQ23", "CMPBGQ14", "CMPBGQ25", "CMPBGQ26", "", "", "Quake2CompendiumGray", "Quake2CompendiumWhite" }},
...
str ClassWeaponInfo[CLASSCOUNT][2][20][5] = 
{
	...
	{{
		...
		{ "Railgun", "(You get this along with BFG10K)\n\nThe Rail Gun fires depleted uranium slugs at super high velocities. Take note of the distinctive blue corkscrew trail of smoke caused by the projectile - or better yet, see how many scumbag Stroggs it goes through before it hits concrete. ", "Q2CMPW08", "Q2Railgun", "7" },
		...
		{ "Ion Ripper", "The Ion Ripper fires blasts of glowing energy boomerangs capable of ricocheting off walls. The Ion Ripper is the perfect weapon for launching attacks around corners and areas out of your line of sight.", "Q2CMPW11", "Q2IonRipper", "u" },
