...
/*	{
	...
	{{
		...
		{"Sand Scorpion", "COMP_THREAT_2", "An oversized scorpion found in arid desert regions. Hardly the most fearsome opponents you will face, but their pincers and stinger can rip apart full grown humans, especially when caught in that fiendish three-hit combo.", "Hexen2YellowScorpion", "CMPMH216"},		
