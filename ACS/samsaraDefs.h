...
int UnloadRemove[UNLOADCOUNT] =
{
	...
	"JonTauntCooldown", "StopFromPickingTurrets_", "StrifeBeaconCooldown"
};
...
int BanCVars[CLASSCOUNT] = 
{
    ...
    "samsara_banblake",
    "samsara_bancaleb",
    "samsara_banstrifeguy",
    "samsara_bandoom64guy",
    "samsara_baneleena",
    "samsara_banspaceseal",
    "samsara_banrebelmooncommando",
    "samsara_bankatarn",
	"samsara_banmooman",
	"samsara_bandisruptor",
	"samsara_bangrondoval", //+Added
	"samsara_banfreeman", //+Added	
	"samsara_banwang", //+Added		
	"samsara_bancm", //+Added
	"samsara_banjon", //+Added	
	"samsara_banrr", //+Added	
	"samsara_banbitterman", //+Added	
};
...
int DamageCVars[CLASSCOUNT] = 
{
	...
	"samsara_freelydamage",
    "samsara_blakedamage",
    "samsara_calebdamage",
    "samsara_strifeguydamage",
    "samsara_doom64guydamage",	
    "samsara_eleenadamage",
    "samsara_spacesealdamage",	
    "samsara_rebelmooncommandodamage",
    "samsara_katarndamage",	
	"samsara_moomandamage", //+Added	
	"samsara_disruptordamage", //+Added		
	"samsara_grondovaldamage", //+Added
	"samsara_freemandamage", //+Added	
	"samsara_wangdamage", //+Added		
	"samsara_cmdamage", //+Added	
	"samsara_jondamage", //+Added	
	"samsara_rrdamage", //+Added	
	"samsara_Bittermandamage", //+Added	
};
...
int DefenseCVars[CLASSCOUNT] = 
{
	...
	"samsara_freelydefense",
    "samsara_blakedefense",
    "samsara_calebdefense",
    "samsara_strifeguydefense",
    "samsara_doom64guydefense",	
    "samsara_eleenadefense",
    "samsara_spacesealdefense",	
    "samsara_rebelmooncommandodefense",
    "samsara_katarndefense",	
	"samsara_moomandefense",	
	"samsara_disruptordefense",		
	"samsara_grondovaldefense", //+Added
	"samsara_freemandefense", //+Added	
	"samsara_wangdefense", //+Added	
	"samsara_cmdefense", //+Added	
	"samsara_jondefense", //+Added	
	"samsara_rrdefense", //+Added	
	"samsara_Bittermandefense", //+Added	
};
