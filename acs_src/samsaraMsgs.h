    ...
    { // WL6
		{
			...
			},
			{
				...
				"Yes, this is the sprite from the Super Nintendo version.",
				...
				"but in the snes version it shoots faster and doesn't rip i don't like it change it.",
		...
		}, // SOD Lost Episodes
		{
			...
			},
			{
				...
				"It's better than the Doomguy's chaingun. How does that even work.",
				"Hold it properly like real gangsters do.",
				"Oh my god! The Nazis are developing cobalt blue AK47s! Gotta tell command ASAP.",
				"Oh my god, this game rips off Call of Duty so much.",
				"Flamethrowers, machineguns, and chemical bombs are okay. Shotguns? \cgDisgusting.\c-",
				"Looks even more like an assault rifle. It's an assault rifle.",
			},
			{
				"You got the Machine Gun!",
				"Nah.",
				...
				"Wait, didn't I just get this?",
				"Now you still can't dual wield them.",
				"Come on. Blue mechanical pencil. You know you want it.",
				"This is bullshit. How come Samsara lets Petton have a slot III and not me!?",
			},
			{
				"You got the Chaingun!",
				"If this were Wolfenstein 3D, you'd just have hit top tier.",
				...
				"The as-salt to the machine gun's pepper.",
				"Oh my god, this game rips off Doom so much.",
				"How did it get so perfectly smooth and round?",
				"Wow this thing is shaped weird.",
			},
			{
				"You got the Rocket Launcher!",
				"Everyday I live in a blue world, where the rockets and rocket launchers are blue, too.",
				"I don't think Wolfenstein 3D really understood rocket launchers.",
				...
				"Just ripped this thing off a killer robot.",
			},
			{
				"You got the Flamethrower!",
				"Because flamethrowers have infinite range.",
				"You can hold the unfunny jokes this time.",
				"Shockingly, it doesn't shoot blue fire.",
				"Yes indeed, it werfs flammens.",
				"God damn this stupid thing is so heavy.",
				"Pretty sure these are tomatoes.",
				"Are we fighting demons, or are we fighting unfunny comedians?",
			...
			},
			{
				...
				"Delicious overpoweredness. What more could you want?",
				"If a weapon stabs Jesus, it becomes superpowered. Who knew?",
				"So you get the Spear of Destiny, after fighting the devil, and his army of green fog, in UAC? Ok.",
				"Poke Of Kill Everything.",
				"You know you're supposed to throw it, right?",
				"I bet it has fake butter, though.",
				"But the Spear of Destiny was inside you all along.",
				"Wait, there's color variety all of a sudden?",
			},
		}, // Mac
		{
			{
			...
			{
				"You got the Machine Gun!",
				"Gotta love finding an M16 in 1943.",
				"Basically a faster, weaker sniper rifle.",
				"Actually more of an assault rifle, but...",
				"It's better than the Doomguy's chaingun. How does that even work.",
				"Motherfucking time travelling nazis! God damn.",
				"This bad boy would look great with a scope! I'm sure there's one around here somewhere...",
				"Oh my god, this is almost exactly like Modern Warfare 2!",
				"Flamethrowers, machineguns, and chemical bombs are okay. Shotguns? \cgDisgusting.\c-",
				"I wonder how accurate rifles will be 800 years from now...",
			},
			{
				"You got the Machine Gun!",
				"The Mac version doesn't have one either.",
				"Well, time to stay the hell away from the dude with the SSG.",
				"No, there will not be a different slot III.",
				"And now for something completely the same.",
				"This is bullshit. How come Samsara lets Petton have a slot III and not me!?",
				"Wait, didn't I just get this?",
				"Now you still can't dual wield them.",
				"Still a completely anachronistic M16.",
				"Hang on to this for another 20 years and you can take it to Vietnam, too.",
			},
			{
				"You got the Chaingun!",
				"In the DOS Version, this was top tier. Unfortunately, this isn't the DOS version.",
				"A constant beam of death from any range. Not bad.",
				"Actually more of a gatling gun, but...",
				"Why wouldn't there be man-portable miniguns? Of course there are!",
				"Hope you like ammo scrounging!",
				"The as-salt to the machine gun's pepper.",
				"Oh my god, this game rips off Doom so much.",
				"Now hold the belt in one hand and fire with the other like they do in the movies.",
				"Sure sounds like an ultimate, but it isn't one in Second Encounter.",
			},
			{
				"You got the Rocket Launcher!",
				"It actually sounds like a rocket launcher is this version.",
				"I don't think Wolfenstein 3D really understood rocket launchers.",
				"Yes, it existed. It was in the Mac version.",
				"Yes, it explodes. A little bit. Shut up.",
				"The tube is clogged. Is that a bad thing?",
			...
			},
			{
				...
				"Yes indeed, it werfs flammens.",
				"God damn this stupid thing is so heavy.",
				"You will believe you can snipe with a flamethrower.",
				"Shoots big globs of gasoline really fast.",
				"Pulled straight out of Vampire Hitler's chest.",
				"This must be absolutely terrible for the environment.",
			},
			{
				"You got the Spear of Destiny! Heaven awaits.",
				"Buttered popcorn, straight from Jesus.",
				...
				"Poke Of Kill Everything.",
				"You know you're supposed to throw it, right?",
				"This will stay the same until there's a Mac spear sprite.",
				"But the Spear of Destiny was inside you all along.",
				"Oh no my hands are suddenly low-res aaaaaaaa.",
			},
		},		
		{
		...
		},
{
	...
	{{
		"Allied Equipment Drop, Flamethrower, or STEN",
		"",
		"",
		"",
		"",
