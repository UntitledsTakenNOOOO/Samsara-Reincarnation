...
str ClassWeaponInfo[CLASSCOUNT][2][20][5] = 
{
	...
	{{
		...
		{ "Disruptor Zodyac", "LightStormer authorities have confirmed the existence of this weapon type. They are used primarily in the outlaw zones of the Solar System and are not officially sanctioned for use by LightStormers.\n\nShoots out a shockwave that stays for a while, damaging any enemy that comes near it.", "SQ72W0", " Disruptor Zodyac ", "7" },
	...
	{{
		...
		{ "Grenade Launcher", "Launches a 40mm explosive shell that bounces before it explodes. It is ideal for dealing death in hard-to-reach places such as ledges or around corners.", "SW20Z0", "SWGrenade", "2" },
		{ "Riotgun", "A quad barrel shotgun.\n\nMode 1: You shoot a concentrated blast through one barrel that will knock an enemy off his feet.\n\nMode 2: You fire all four barrels, with a wider spread.", "SW30Z0", "SWRiotgun", "3" },
	...
	{{
		{ "Blaster", "This is the standard issue rechargeable energy side-arm.  It does not require ammunition. Useful for taking down Guards as well as exploding barrels and setting off shootable buttons and secret doors. Keep one on you at all times.", "", "Q2Blaster", "p" },
		{ "Machinegun", "Although this weapon is easy to use, its light weight allows for considerable kickback that will push your gun up. Fire in short burst until you can effectively steady your aim.", "", "Q2MachineGun", "1" },
		{ "Shotgun", "This uses shells for ammunition. The spread of the shotgun blast makes close combat more damaging, but long range attacks easier. Perfect for the less than proficient marksman. The shotgun is effective against Strogg Guards and Flyers.", "", "Q2Shotgun", "2" },
		{ "Super Shotgun", "This is the uncompromising big brother to the Shotgun. Choose your shots effectively. The slow firing rate may only give you a few chances to bring down the enemy before he's able to engage you up close. It eats more shells than the Shotgun, but the show is well worth it.", "", "Q2SuperShotgun", "3" },
		{ "Chaingun", "The chain gun makes mince meat out of your enemy, but requires an insane amount of ammunition. The long spin up and spin down time makes the chain gun most effective for sustained attacks.", "", "Q2Chaingun", "4" },
		{ "Rocket Launcher", "The rocket launcher delivers heavy fire power to your target. Be careful not use this weapon in close combat.", "", "Q2RocketLauncher", "5" },
		{ "Hyper Blaster", "A hyper blaster is an energy chain gun with no spin up delay. Its high rate of fire is incredibly effective at destroying the enemy and depleting your energy cells.", "", "Q2HyperBlaster", "6" },
		{ "BFG10K", "Big, uh, freakin' gun.  This weapon redefines the word \"wallpaper.\"  Simply fire the BFG into a small room of unsuspecting Strogg and observe the new red paint job. ", "", "Q2BFG10K", "7" },
		{ "Railgun", "(You get this along with BFG10K)\n\nThe Rail Gun fires depleted uranium slugs at super high velocities. Take note of the distinctive blue corkscrew trail of smoke caused by the projectile - or better yet, see how many scumbag Stroggs it goes through before it hits concrete. ", "", "Q2Railgun", "7" },
		{ "Grenade Launcher", "The grenade launcher is useful for delivering firepower into hard to reach areas or clearing out potential ambushes. We do not recommend using the grenade launcher in confined areas.", "", "Q2GrenadeLauncher", "u" },
		{ "Ion Ripper", "The Ion Ripper fires blasts of glowing energy boomerangs capable of ricocheting off walls. The Ion Ripper is the perfect weapon for launching attacks around corners and areas out of your line of sight.", "", "Q2IonRipper", "u" },
		{ "ETF Rifle", "It's powerful, efficient, and able to pierce armor. What more could you ask for? This weapon fires explosive-tipped flechettes that pack a deadly wallop. ", "", "Q2ETFRifle", "u" }
	}},
	{{
...
str MonsterInfo[CLASSCOUNT][64][21] =
{
	...
	},
	{
		...
		{ "Coolie", "COMP_THREAT_3", "Walks around with a box of explosives. Poses little threat from a distance, but if he gets near you he blows up, causing severe damage.", "Coolie", "COOLA1" },
		{ "Coolie Ghost", "COMP_THREAT_3", "Not content with attacking you once, some Coolies will spawn a spectral ghost after they make their ultimate sacrifice. These apparitions float around phasing in and out of existence, taking time out to heave nasty gobs of bloody goo at you.", "CoolieGhost", "GHOSA1" },
		...
		{ "Guardian", "COMP_THREAT_4", "These hard to kill beasts use swords at short range, switching to fireballs when farther away. Note: Sometimes after killing one, you can harvest its decapitated head and use it as a weapon.", "Guardian", "GUARA1" },
	...
	},
	{
		...
		{ "Kilmaat Sentry", "", "Your run-of-the-mill alien worker. Usually encountered working around alien structures, he will attack with a nasty laser pistol if disturbed.", "KilmaatSentry", "KILMA1" },
		{ "Bastet", "", "This is one fierce and wily lioness. She is extremely fast, has razor-sharp claws and can teleport at will - a lethal mix of skills in anyone's book.", "Bastet", "BASTA1" },
		{ "Hawk", "", "The ancient Egyptian tombs still have hawks lurking around and unfortunately these ones are not the friendly type.", "ExHawk", "HAWKA1" },
		{ "Omen Wasp", "", "These buzzing nasties flit about and deliver a nasty sting. They are very hard to target, so use caution when fighting them.", "OmenWasp", "OWDEA1" },
		{ "Ancient Mummy", "", "Fairly slow moving, but can dole out some serious damage. They use an enchanted staff to fire powerful phantom skulls at you (which, by the way, can also resurrect fallen mummies, so be extra careful if you encounter more than two at a time). Also, some of the phantom skulls are red, and if you are hit by one you suffer the mummy's curse...", "ExMummy", "PSMUF1" },
		{ "Magmantis", "", "This lava-dwelling denizen rises up to unleash high-speed fire balls at unlucky individuals. Move quick, keep your distance and take advantage of whatever cover you can find.", "Magmantis", "PSMAA1" },
		{ "Omen Wasp Necromancer", "", "A resurrected counterpart of the Omen Wasp, this one poses a greater threat so be quick and have lots of ammunition to exterminate this!", "OmenWaspNecro", "PSONA1" },
		{ "Ammit", "", "The dreaded \"Eater of the Dead\". It usually feasts on the souls of the newly dead, but has been enslaved by the Kilmaat to slay the living! A fearsome and tough foe, it possesses a nearly impenetrable armored hide and can smash your bones easily within its gaping maw. Normal attacks do little to no damage, so look for a weak spot and exploit it.", "Ammit", "AMITA1" },
		{ "Selkis", "", "This demonic nightmare is a result of alien genetic experiments. Even the most experienced of game players will be in for a surprise when fighting this beast.", "Selkis", "CMPMPS12" },
		{ "Set", "", "The most foul and evil of all the Egyptian gods, Set wants nothing more than to slowly devour your soul. After he smashes your body to a pulp, of course.", "PSSet", "PSETA1" },
		...
		else
		{
			...
			else if(menutab == 3)
			{
				...
				{			
					...
					SetHudClipRect(FixedMul(hudcenterx,0.775),FixedMul(hudcentery,0.5),FixedMul(hudcenterx,0.175),FixedMul(hudcentery,0.45),FixedMul(hudcenterx,0.15));
					HudMessage(s:"Health: ", d:hitpoints; HUDMSG_PLAIN|HUDMSG_NOTWITHFULLMAP|HUDMSG_LAYER_OVERHUD|HUDMSG_COLORSTRING, 16160, ClassInfo[(menuindex-1)][altskin][16], (FixedMul(hudcenterx,0.7825)<<16)+0.1, (FixedMul(hudcentery,0.51)<<16)+0.1, 0);	
					HudMessage(l:MonsterInfo[menuindex-1][menuitem-1][1]; HUDMSG_PLAIN|HUDMSG_NOTWITHFULLMAP|HUDMSG_LAYER_OVERHUD|HUDMSG_COLORSTRING, 16161, ClassInfo[(menuindex-1)][altskin][16], (FixedMul(hudcenterx,0.7825)<<16)+0.1, (FixedMul(hudcentery,0.54)<<16)+0.1, 0);	
					HudMessage(s:"Spawn Class: ", s:MonsterInfo[menuindex-1][menuitem-1][3+(2*monsterskin)]; HUDMSG_PLAIN|HUDMSG_NOTWITHFULLMAP|HUDMSG_LAYER_OVERHUD|HUDMSG_COLORSTRING, 16162, ClassInfo[(menuindex-1)][altskin][16], (FixedMul(hudcenterx,0.7825)<<16)+0.1, (FixedMul(hudcentery,0.59)<<16)+0.1, 0);	
					SetHudClipRect(0,0,0,0,0);
