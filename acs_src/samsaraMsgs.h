...
int ClassPickupMessages[CLASSCOUNT][MAXMODES][SLOTCOUNT][MSGCOUNT] = 
{
    ...
    {{
		...
		},	  
	   {
			...
			{ "You got the VileThorn Javelins!","Now you have the power of 'Yellow'!","How many of these things can you fit in your loincloth?","Reach out and touch somebody.","Bananas. Now in \cgDEATH\c- flavor.","Suprisingly Aerodynamic.","What? Were you expecting a gun?","Many a salmon have been caught with this.","This dude has the throwing arm of a mf!","Like Lutefisk in a barrel of Lye!",},
